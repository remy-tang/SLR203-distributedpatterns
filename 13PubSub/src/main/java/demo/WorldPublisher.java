...
public class WorldPublisher extends UntypedAbstractActor {
	...
	private ArrayList<ActorRef> topics = new ArrayList<ActorRef>();
	...
	public void onReceive(Object message) throws Throwable {
		if(message instanceof ActorRef) {
			...
			getContext().system().scheduler().scheduleOnce(Duration.ofMillis(1500), getSelf(), "go", getContext().system().dispatcher(), ActorRef.noSender());
		}
