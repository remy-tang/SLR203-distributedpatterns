...
public class MediatorActor extends UntypedAbstractActor {
	...
	public MediatorActor() {
	}

	// Static function creating actor
	public static Props createActor() {
		return Props.create(MediatorActor.class, () -> {
			return new MediatorActor();
		});
	}
	 ...
	 *
	 * @Override public Receive createReceive() { return receiveBuilder() // When
	 *           receiving a new message containing a reference to an actor, //
	 *           Actor updates his reference (attribute). .match(ActorRef.class, ref
	 *           -> { this.actorRef = ref; log.info("Actor reference updated ! New
	 *           reference is: {}", this.actorRef); }) .build(); }
	 */
}
